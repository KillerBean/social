    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Update your profile photo</h4>
            ...
            <div class="modal-body">
                ...
                <span class="btn btn-success fileinput-button">
                    ...
                    <input id="fileupload" type="file" name="image" data-url='{{route("account.save")}}' data-token="{{csrf_token()}}" data-user-id="{{Auth::User()->id}}">
                </span>
                <br>
                <br>
