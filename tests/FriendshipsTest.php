...
class FriendshipsTest extends TestCase
{
    ...
    {
        $sender     = factory(App\User::class)->create();
        $recipients = factory(App\User::class, 3)->create();
    ...
    {
        $sender     = factory(App\User::class)->create();
        $recipients = factory(App\User::class, 4)->create();
    ...
    {
        $sender     = factory(App\User::class)->create();
        $recipients = factory(App\User::class, 6)->create();
    ...
    public function it_returns_user_friends_of_friends()
    {
        ...
        $fofs       = factory(App\User::class, 5)->create()->chunk(3);
    ...
    public function it_returns_user_mutual_friends_per_page()
    {
        $sender     = factory(App\User::class)->create();
        $recipients = factory(App\User::class, 2)->create();
        $fofs       = factory(App\User::class, 8)->create()->chunk(5);
